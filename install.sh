...
CONFIGFOLDER='/root/.absolutecore'
CONFIGFOLDER2='/root/.absolutecore2'
CONFIGFOLDER3='/root/.absolutecore3'
COIN_DAEMON='/root/abs-ip-install/absolute_12.2.2_linux/absoluted'
COIN_CLI='/root/abs-ip-install/absolute_12.2.2_linux/absolute-cli'
COIN_DAEMON2='absoluted'
COIN_CLI2='absolute-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/absolute-community/absolute/releases/download/12.2.2/absolute_12.2.2_linux.tar.gz'
COIN_ZIP='/root/abs-ip-install/absolute_12.2.2_linux.tar.gz'
COIN_NAME='abs'
COIN_NAME2='abs2'
COIN_NAME3='abs3'
COIN_PORT=18888
